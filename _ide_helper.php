 ...
 * Generated for Laravel 5.3.31 on 2017-07-13.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function attachment($content, $filename)
        {
            return \Illuminate\Routing\ResponseFactory::attachment($content, $filename);
        }
