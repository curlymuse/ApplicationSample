...
use App\Mail\MultipleRecipientTypes\ChangeOrder\ChangeOrderSetProcessedByOtherParty;
use App\Repositories\Contracts\UserRepositoryInterface;
use App\Traits\SendsMailables;
use Illuminate\Queue\InteractsWithQueue;
use Illuminate\Contracts\Queue\ShouldQueue;

class ListenThenSendChangeOrderProcessedEmailToReceivingParty
{
    use SendsMailables;
    ...
    public function handle(ChangeOrderSetWasProcessed $event)
    {
        ...
        $this->sendMailable(
            $users,
            ChangeOrderSetProcessedByOtherParty::class,
            [
