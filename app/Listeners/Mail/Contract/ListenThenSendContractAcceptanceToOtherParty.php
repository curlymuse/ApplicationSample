...
use App\Mail\MultipleRecipientTypes\Contract\ContractAcceptedByOtherParty;
...
class ListenThenSendContractAcceptanceToOtherParty
{
    use SendsMailables;
    ...
    public function handle(ContractWasAccepted $event)
    {
        ...
        $this->sendMailable(
            $recipients,
            ContractAcceptedByOtherParty::class,
            [
                $signatory,
                $contract,
                $event->getUserType(),
