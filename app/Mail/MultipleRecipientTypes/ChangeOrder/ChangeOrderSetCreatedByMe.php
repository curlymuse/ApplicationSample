...
class ChangeOrderSetCreatedByMe extends MyMailable
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.multiple.change-order.created-by-me')
            ->text('emails.multiple.change-order.created-by-me_plain')
            ->from(config('mail.from.address'), $data['licensee'])
            ->subject(
                sprintf(
                    'Proposed Changes for %s Sent',
